...
if __name__ == '__main__':
    ...
    for p in part:
        ...
        if not os.path.exists(out_folder_):
            os.makedirs(out_folder_)
        label_path = '{}/kinetics_{}_label.json'.format(data_path_, p)
        data_path = '{}/kinetics_{}'.format(data_path_, p)
        data_out_path = '{}/kinetics_{}_data.npy'.format(out_folder_, p)
        label_out_path = '{}/kinetics_{}_label.pkl'.format(out_folder_, p)
